...
$(document).ready(function(){
   ...
   //비밀번호 blur
   $('#userpwMod').blur(function(){
      if(upwReg.test($('#userpwMod').val())){
   ...
   $('#userpw_ck').blur(function(){
      ...
      } else if($('#userpwMod').val() != $(this).val()){      
...
//             alert("비밀번호는 6에서 18자리 소문자, 숫자를 ~");
         ...
         //#userpw_ck
         if( $("#userpwMod").val() != $("#userpw_ck").val() ){
      ...
      <!-- Banner -->
         <section id="banner">         
            <div class="content">
               ...
               <ul class="actions">
                  <li><a href="#one" class="button scrolly">회원 정보 변경</a></li>
               </ul>
            </div>
         </section>
...
<div class="container">
   ...
   <p class="tit_36" id="one">회원정보 변경 <span class="label">(필수는 꼭 해주세요!)</span></p>
   <hr>
   ...
   <table>
      ...
      <tr>   
         <td>
            ...
            <input type="password" placeholder="비밀번호" name="userpw" id="userpwMod" required style=" width: 385px"/></label>
